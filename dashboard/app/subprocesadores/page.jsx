...
const SUBPROCESADORES = [
  {
    ...
    region: "UE — eu-central-1 (Frankfurt), confirmado en el proyecto de producción real",
  ...
  },
  {
    ...
    region: "UE — Frankfurt (fra1), confirmado en el proyecto de producción real",
  ...
  },
  {
    ...
    region: "UE — EU West (Amsterdam), confirmado en el proyecto de producción real",
  ...
  },
  {
    ...
    region: "Aún no activado en producción — pendiente (ver ROADMAP.md, Fase 17 D.1)",
